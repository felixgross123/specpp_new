...
public class ParameterRequirements {
     ...
     * Gamma
     */
    public static final ParameterRequirement<GammaETCPrecisionGainThreshold> GAMMA_ETCPRECISIONGAIN_THRESHOLD = parameters("gamma.parameters", GammaETCPrecisionGainThreshold.class);

    /**
     * Rho
     */
    public static final ParameterRequirement<RhoETCPrecisionThreshold> RHO_ETCPRECISION_THRESHOLD = parameters("rho.parameters", RhoETCPrecisionThreshold.class);
