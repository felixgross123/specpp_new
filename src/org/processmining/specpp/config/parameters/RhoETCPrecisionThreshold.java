 ...
 */
public class RhoETCPrecisionThreshold implements Parameters {
     ...
     */
    public static RhoETCPrecisionThreshold rho(double p) {
        return new RhoETCPrecisionThreshold(p);
    }
    ...
    * @return RhoETCPrecisionThreshold-parameter
    */
    public static RhoETCPrecisionThreshold getDefault() {
        return rho(1.0);
    }
     ...
     * @param p Value for rho.
     */
    public RhoETCPrecisionThreshold(double p) {
        this.rho = p;
    }
